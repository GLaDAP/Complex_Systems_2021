...
DESCRIPTION: Model class, based on Model class from MESA. The class consists
             of multiple methods, resonsible fore either init certain agents
             on the grid or keeping track of the data, generated by the model.
"""
import time, os
